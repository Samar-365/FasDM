  ...
  return (
    <div className="w-full flex flex-col gap-4 font-sans">
      ...
      <div
        ...
        className="glass-panel p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 border border-cyan-500/20 bg-slate-900/80 backdrop-blur-md rounded-2xl shadow-xl"
      >
        ...
        <div className="flex items-center gap-3 relative">
          ...
          {showSessionSelector && (
            <>
              ...
              />
              <div
                style={{ backgroundColor: '#090d16', zIndex: 50 }}
                className="absolute top-full mt-2 left-0 w-80 sm:w-96 border border-cyan-500/40 rounded-xl p-3.5 shadow-[0_20px_50px_rgba(0,0,0,0.95)] space-y-3 max-h-[420px] overflow-y-auto"
              >
                <div className="flex items-center justify-between pb-2 border-b border-slate-800">
                  <span className="text-xs font-bold text-cyan-400 uppercase font-mono tracking-wider">Select Active Mesh Session</span>
                  <button
                    onClick={() => setShowSessionSelector(false)}
                ...
                <button
                  ...
                  style={{ backgroundColor: sessionType === 'scratch' ? '#162235' : '#0f172a' }}
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-cyan-950 flex items-center justify-center text-cyan-400 font-bold shrink-0">
                    ★
                  </div>
                  <div>
                  ...
                  {availablePeers.length === 0 ? (
                    ...
                    availablePeers.map((peer) => (
                      <button
                        ...
                        style={{ backgroundColor: sessionType === 'peer' && selectedSessionId === peer.deviceId ? '#162544' : '#0f172a' }}
                      ...
                      >
                        ...
                        <span className="text-[10px] font-mono text-slate-400 px-1.5 py-0.5 rounded bg-slate-800 shrink-0">
                          {peer.connectionType}
                        </span>
                      </button>
                    ))
                  ...
                  {availableGroups.length === 0 ? (
                    ...
                    availableGroups.map((group) => (
                      <button
                        ...
                        style={{ backgroundColor: sessionType === 'group' && selectedSessionId === group.groupId ? '#22153b' : '#0f172a' }}
          ...
          <div className="relative">
            ...
            {showExportMenu && (
              <>
                ...
                <div
                  style={{ backgroundColor: '#090d16', zIndex: 50 }}
                  className="absolute right-0 top-full mt-2 w-64 border border-slate-700/80 rounded-xl p-2 shadow-[0_20px_50px_rgba(0,0,0,0.95)] space-y-1"
                >
                  <button
                    onClick={() => handleExportData('png')}
                    className="w-full px-3 py-2 rounded-lg text-left text-xs font-medium text-slate-200 hover:bg-slate-800 hover:text-white flex items-center gap-2.5 transition whitespace-nowrap"
                  >
      ...
      <div
        ...
        className="flex flex-wrap items-center justify-between gap-3 p-1.5 bg-slate-950/90 rounded-2xl border border-slate-800"
      >
        <div className="flex items-center gap-2">
          {/* Tab 1: Whiteboard */}
          <button
      ...
      <div
        ...
        className="w-full min-h-[600px] rounded-2xl border border-slate-800 bg-slate-950/60 backdrop-blur-lg p-3 sm:p-5 relative overflow-hidden"
      >
